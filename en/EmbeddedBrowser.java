...
class EmbeddedBrowser extends JEditorPane{
	...
	private final String GO_HOME_STR = new String("Home page") ;
	private final String GO_BACK_STR = new String("Previous page") ;
	private final String GO_NEXT_STR = new String("Next page") ;
	private final String REFRESH_STR = new String("Refresh") ;
	private final String GOTO_STR    = new String("Go to...") ;
	private final String INFO_STR    = new String("Info") ;
	...
	private URL showGotoPanel(){
		...
		final String GOTO_MSG    = new String("Give the URL you want to visit: ") ;
		final String GOTO_TITLE  = new String("Go to...") ;
	...
	private void showBadURLMessageDialog(){
		...
		final String ERROR_MSG   = new String("Invalid URL") ;
		final String ERROR_TITLE = new String("The given URL have invalid form!") ;
	...
	private String fileNotFound(URL fileNotFound, URL previusPage){
		return new String("<html></body><font size=\"5\" color=\"#ff0000\">Error 404 - </font><font size=\"4\" color=\"#ff0000\">File not found!</font><p>The file <b>" + fileNotFound.toExternalForm() + "</b> not found, or its format is unsupported.<a href=\"" + previusPage.toExternalForm() + "\"> Back to to previous page...</a></body></html>") ;
	}
	...
	private String homePageNotFound(){
		return new String("<html><body><font size=\"5\" color=\"#ff0000\">Error 404 - </font><font size=\"4\" color=\"#ff0000\">The home page not found!</font><p>The file <font color=\"#0000ff\">" + homePage.toExternalForm() + "</font> witch contains the information that will appear in this box not found or damaged.</p><p>To resolve the problem, please install the program again.</p></body></html>") ;
	}
	...
	private String unknownHost(URL targetURL, URL previusPage){
		return new String("<html></body><font size=\"5\" color=\"#ff0000\">Error 503 - </font><font size=\"4\" color=\"#ff0000\">ʼγνωστος διακομιστής</font><p>The server <b>" + targetURL.getHost() + "</b> not found. Perhaps the URL you provided is not correct or your computer is not connected to the internet.<p><a href=\"" + previusPage + "\">Back to previous page...</a></p></body></html>") ;
	}
}
