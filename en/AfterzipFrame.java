...
class AfterzipFrame extends Object {
	...
	private final String SPLIT_MSG 		= new String("Split") ;
	private final String MERGE_MSG 		= new String("Merge") ;
	private final String OPTIONS_MSG 	= new String("Options") ;
	private final String HELP_MSG 		= new String("Help") ;
	private final String ABOUT_MSG 		= new String("Info") ;
	...
	private static final String UNSUPPORTED_LAF_EXCEPTION_MSG 	= new String("The selected theme is not supported at your system.\nThe program will use the default theme of your platform.\n\nException in class:\n") ;
	private static final String INSTANTIATION_EXCEPTION_MSG 	= new String("Error at the selected theme installation.\nThe program will use the default theme of your platform.") ;
	private static final String CLASS_NOT_FOUND_EXCEPTION_MSG 	= new String("The selected theme classes not found.\nFile not exist or the CLASSPATH is invalid.\nThe program will use the default theme of your platform.\n\nException in class:\n") ;
	private static final String ILLEGAL_ACCESS_EXCEPTION_MSG 	= new String("Access at selected theme class denied.\nThe program will use the default theme of your platform.") ;
	private static final String GENERAL_UI_EXCEPTION_MSG 		= new String("Error at UI loading!\n") ;

	private static final String EXCEPTION_TITLE = new String("Exception Thrown") ;
	private static final String EXCEPTION_CLASS_TITLE = new String("Exception Thrown.\n\nException in class:\n") ;
