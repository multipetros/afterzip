...
class HelpPanel extends JPanel{
	...
	private final String INTRO_BUTTON_TEXT 		= new String("Εισαγωγή") ;
	private final String INTRO_BUTTON_TOOLTIP	= new String("Εμφανίζει την εισαγωγική βοήθεια για την εφαρμογή") ;
	private final String SPLIT_BUTTON_TEXT 		= new String("Τεμαχισμός") ;
	private final String SPLIT_BUTTON_TOOLTIP 	= new String("Εμφανίζει βοήθεια για την διαδικασία τεμαχισμού") ;
	private final String MERGE_BUTTON_TEXT 		= new String("Συγχώνευση") ;
	private final String MERGE_BUTTON_TOOLTIP 	= new String("Εμφανίζει βοήθεια για την διαδικασία συγχόνευσης") ;
	private final String OPTIONS_BUTTON_TEXT 	= new String("Ρυθμίσιες") ;
	private final String OPTIONS_BUTTON_TOOLTIP = new String("Εμφανίζει βοήθεια για τις ρυθμίσεις που μπορεί να κάνει ο χρήστης") ;
	private final String TOOLBAR_TEXT 			= new String("Περιεχόμενα") ;
	...
	private String printError404(File fileNotFound){
		return new String("<html><body><font size=\"5\" color=\"#ff0000\">Σφάλμα 404</font><br><font size=\"4\" color=\"#ff0000\">Το αρχείο δεν βρέθηκε!</font><p>Το αρχείο <font color=\"#0000ff\">" + fileNotFound.toString() + "</font> που περιέχει τις πληροφορίες που θα εμφανιζόταν σε αυτό το πλαίσιο δεν βρέθηκε ή έχει καταστραφεί.</p><p>Για να λυθεί το πρόβλημα παρακαλώ εγκαταστήστε ξανά την εφαρμογή.</p></body></html>") ;
	}
