...
class SuccessOrFailureMessage extends JOptionPane{
	...
	public final static String SUCCESS_MESSAGE = new String("Η διαδικασία ολοκληρώθηκε με επιτυχία") ;
	public final static String FAILURE_MESSAGE = new String("Προσοχή!\nΗ εκτέλεση της διαδικασίας απέτυχε!") ;
	public final static String TITLE = new String("Aποτέλεσμα εκτέλεσης") ;
