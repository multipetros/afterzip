...
class AboutPanel extends JPanel {
	...
	private final String APP_VERSION = "Έκδοση 1.2.0" ;
	private final String COPYRIGHT = "(C) 2004 - Πέτρος Φ. Κυλαδίτης" ;
	private final String SITE_URL = "<html><body><center>Διεύθυνση ιστοτόπου: <a href=\"mp\">http://www.multipetros.gr/</a></center></body></html>" ;
	private final String SYSINFO = "<html><body><center><a href=\"hh\">Πληροφορίες συστήματος</a></center></body></html>" ;
	private final String APP_NAME_TOOLTIP = "Το όνομα της εφαρμογής." ;
	private final String APP_VERSION_TOOLTIP = "Η τρέχουσα έκδοση της εφαρμογής." ;
	private final String COPYRIGHT_TOOLTIP = "Ο κάτοχος των πνευματικών δικαιωμάτων." ;
	private final String SITE_URL_TOOLTIP = "Ο ιστότοπος του κατασκευαστή" ;
	private final String SYSINFO_TOOLTIP = "Κάντε κλικ για να δείτε πληροφορίες για το σύστημά σας." ;
	...
	private final String MSG_TITLE = "Πληροφορίες συστήματος" ;
	private final String USERNAME = "Συνδεδεμένος χρήστης: " ;
	private final String COMPUTER = "σε Υ/Η " ;
	private final String ARCHITECTURE = " αρχιτεκτονικής " ;
	private final String CPU = " ενός επεξεργαστή" ;
	private final String CPUS = " επεξεργαστών" ;
	private final String OPERATING_SYSTEM = "με λειτουργικό σύστημα " ;
	private final String JAVA = "με υλοποίηση Java" ;
	private final String JAVA_VENDOR = " της " ;
	private final String VERSION = " έκδοσης " ;
	private final String JAVA_URL = "Ιστότοπος κατασκευαστή Java: " ;
	private final String NEW_LINE = "\n" ;
	private final String NONAME_USER = "Συνδεδεμένος άγνωστος χρήστης" ;
			...
			new MouseAdapter(){
				public void mouseClicked(MouseEvent event){
					try{
						...
						JOptionPane.showMessageDialog(getParent(), exception.getMessage(), "Σφάλμα", JOptionPane.INFORMATION_MESSAGE) ;
					}
				}
			}
		) ;
