...
final class ResetQuestionMessage extends JOptionPane{
	...
	private final static String QUESTION_TITLE = new String("Ερώτηση προς τον χρήστη") ;
	private final static String QUESTION_MESSAGE = new String("Θέλετε να γίνει τώρα επαννεκίνηση της εφαρμογής ;") ;
